...
$ambil = $conn->query("SELECT * FROM produk WHERE 	nama_produk LIKE '%$keyword%' OR
...
<head>
	...
	<title>Hasil Pencarian Dari <?php echo $keyword ?></title>
...
<body>
	...
	<section class="konten">
		<div class="container">
			<h1>Hasil Pencarian Dari <?php echo $keyword ?></h1>
